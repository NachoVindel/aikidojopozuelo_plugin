...
function code_adp_ficha_alumno($idAlumno)
{
    ...
    $out.= ($alumno->LicenciaAikikan==null) ? ('<li style="text-decoration: blink;color:red">SIN LICENCIA</li>') : ('<li><a href="'.$alumno->LicenciaAikikan.'" target="_blank">Ver Licencia</a></li>');
