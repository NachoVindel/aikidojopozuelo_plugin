...
function adp_crear_blog_de_alumno($alumno)
{
	...
	*******************************************************/
	...
	$postStatus = 'private';  // set to future, draft, or publish

	$leadContent = '<p>Hola ' . $alumno->Nombre . '!</p><p>En este blog intercambiaremos la información sobre tu evolución.</p><p>Puedes escribirme o preguntarme lo que quieras, yo lo utilizaré para dejarte notas, comentarios o cualquier cosa que pueda ayudarte de cara a tu evolución.</p><p>Nadie más que tú y yo veremos este blog.</p>';
